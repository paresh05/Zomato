...
function RestaurantDetails() {
  ...
  const [restaurant, setRestaurant] = React.useState([{
    name: null, rating: null, description: null, location: null,
  }]);
  const [menuItems, setMenuItems] = React.useState([]);
  const [subImages, setSubImages] = React.useState([{ url: null }, { url: null }, { url: null }]);
  const fetchRestaurant = () => {
    restaurantApi
      ...
      .then((response) => {
        ...
        setMenuItems(response.data.attributes.menu);
        setSubImages(response.data.attributes.subImages);
      })
      .catch((e) => {
        console.log(e);
      });
